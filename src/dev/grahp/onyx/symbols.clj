...
(def special-symbols (update-vals symbols #(mapv symbol-names %)))
...
(gen-dict "onyx-symbols.json"
          (apply merge (for [[symbol-chord [sym1 sym2 sym3 sym4]] symbols
